...
const SPECIFIED_TIMEZONE = ["America/New_York", "America/Phoenix", "Asia/Taipei", "Asia/Tokyo"];
...
class Time {
    constructor(app) {
        ...
        this.addTimeZone("America/New_York", ["美東", "edt", "westamerica", "westus", "westusa", "wus"]);
